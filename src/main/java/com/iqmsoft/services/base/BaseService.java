...
public abstract class BaseService<T extends IEntity> implements IService<T>, Serializable {
    ...
    /**
     * @see com.iqmsoft.services.base.IService#add(com.iqmsoft.domain.base.IEntity)
     */
    @Override
    ...
    /**
     * @see com.iqmsoft.services.base.IService#update(com.iqmsoft.domain.base.IEntity)
     */
    @Override
    @Transactional(readOnly = false)
    ...
    /**
     * @see com.iqmsoft.services.base.IService#delete(com.iqmsoft.domain.base.IEntity)
     */
    @Override
    @Transactional(readOnly = false)
    ...
    /**
     * @see com.iqmsoft.services.base.IService#delete(java.lang.Long)
     */
    @Override
    @Transactional(readOnly = false)
    ...
    /**
     * @see com.iqmsoft.services.base.IService#deleteMany(java.lang.Iterable)
     */
    @Override
    @Transactional(readOnly = false)
    ...
    /**
     * @see com.iqmsoft.services.base.IService#findById(java.lang.Long)
     */
    @Override
    ...
    /**
     * @see com.iqmsoft.services.base.IService#list()
     */
    @Override
    public List<T> list() {
    ...
    /**
     * @see com.iqmsoft.services.base.IService#count()
     */
    @Override
    public long count() {
    ...
    /**
     * @see com.iqmsoft.services.base.IService#list(com.iqmsoft.jsf.datatable.PaginationConfiguration)
     */
    @Override
    ...
    /**
     * @see com.iqmsoft.services.base.IService#count(com.iqmsoft.jsf.datatable.PaginationConfiguration)
     */
    @Override
