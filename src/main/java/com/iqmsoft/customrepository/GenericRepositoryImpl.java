...
public class GenericRepositoryImpl<T, ID extends Serializable> extends QueryDslJpaRepository<T, ID> implements
    ...
    /**
     * @see com.iqmsoft.customrepository.GenericRepository#findOne(java.io.Serializable, java.util.List)
     */
    @Override
    ...
    /**
     * @see com.iqmsoft.customrepository.GenericRepository#findAll(com.mysema.query.types.Predicate, org.springframework.data.domain.Pageable, java.util.List)
     */
    @Override
